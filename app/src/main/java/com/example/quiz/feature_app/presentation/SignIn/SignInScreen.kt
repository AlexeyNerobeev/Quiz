...
import com.example.quiz.common.leagueSpartanRegular
        ...
        Column(modifier = Modifier
            ...
            Column(modifier = Modifier
                ...
                Text(text = "Добро пожаловать",
                    ...
                    fontSize = 20.sp,
                    fontFamily = poppinsSemiBold)
                Text(text = "Пожалуйста, введите свои данные, чтобы продолжить.",
                    color = Color.Black,
                    fontSize = 14.sp,
                ...
                OutlinedTextField(value = state.password,
                    ...
                    trailingIcon = {
                        Icon(painter = painterResource(R.drawable.eye_icon),
                            ...
                            modifier = Modifier
                                .clickable{vm.onEvent(SignInEvent.VisualTransformation)})
                    }
                )
                Button(onClick = {
